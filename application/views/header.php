			...
			<div class="header-banner-top">
			   <div class="header-banner-right">
				 ...
				 <div class="head-box">
					...
					<div class="bwn">
						<a  href="single.html"> Select Now </a>
					</div>
		...
		<div class="h-strip-main">
			<div class="h-strip-logo">
				<div class="h-strip-left">
					<h1><a href="<?php echo base_url();?>">Jaunt</a></h1>
				</div>
				<div class="h-strip-right">
				  <form method="get" action="<?php echo base_url('home/cari'); ?>">
					<input type="text" value="Search" name="cari" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Search';}"/>
